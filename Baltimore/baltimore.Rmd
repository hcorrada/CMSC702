...
First lets look at the incident offenses:
```{r Rob Argue}
#setwd("C:/Users/Rob/Documents/GitHub/CMSC702/Baltimore")

with(arrest_tab,table(incidentOffense))
```
...
So looking at these in a table:
...
with(arrest_tab,table(incidentOffense[incidentOffense %in% violent]))
```

And plotting them along with arrests in general:
